        ...
        for stock_picking in lines :
            ...
            if stock_move_lines:
                for index,line in enumerate(stock_move_lines) : 
                    ...
                    #table 1
                    sheet.merge_range(1,0,2,1, "製造工場 ", format_gray_center_size10)
                    sheet.merge_range(3,0,4,1, "受注番号 ", format_gray_center_size10)
                    sheet.merge_range(1,2,2,4, "リッツウェル製造部 ", format_white_center_size11)
                    sheet.merge_range(3,2,4,4,stock_picking.name , format_white_center_size20)

                    #table 2
                    sheet.merge_range(1,6,2,7, "工場責任者", format_gray_center_size8)
                    sheet.merge_range(1,8,2,8, "リッツウェル", format_gray_center_size8)
                    sheet.merge_range(3,6,6,7, "㊞", format_white_center_size10)
                    sheet.merge_range(3,8,6,8, "㊞", format_white_center_size10)

                    #table 3
                    sheet.merge_range(8,0,9,1, "確認", format_gray_center_size10)
                    sheet.merge_range(8,2,9,4, "製品名", format_gray_center_size9)
                    sheet.merge_range(8,5,9,5, "数", format_gray_center_size9)
                    sheet.merge_range(8,6,9,7, "仕様", format_gray_center_size9)
                    sheet.merge_range(8,8,9,8, "張地", format_gray_center_size9)
                    sheet.merge_range(10,0,11,0, "□", format_cell_tick)
                    sheet.write(10,1, "通常", format_white_center_size8)
                    sheet.write(11,1, "別注", format_white_center_size8)
                    ...
                    #table 4
                    sheet.merge_range(13,0,13,3, "■最終検品時　作業確認表", format_head_title)
                    sheet.merge_range(14,0,15,0, "確認", format_gray_center_size9)
                    sheet.merge_range(14,1,15,3, "作業項目", format_gray_center_size9)
                    sheet.merge_range(14,4,15,7, "注意点", format_gray_center_size9)
                    ...
                    sheet.merge_range(16,1,17,3, "取り付け・加工等", format_white_left_size10)
                    sheet.merge_range(18,1,19,3, "外観チェック", format_white_left_bold_size10)
                    sheet.merge_range(20,1,21,3, "直座り検査", format_white_left_size10)
                    sheet.merge_range(22,1,23,3, "脚部強度確認", format_white_left_bold_size10)
                    sheet.merge_range(24,1,25,3, "レベル・脚裏確認", format_white_left_size10)
                    sheet.merge_range(26,1,27,3, "検印シール", format_white_left_size10)
                    sheet.merge_range(28,1,29,3, "", format_white_left_size10)
                    sheet.merge_range(16,4,17,7, "脚切・プラパート・同梱物・その他", format_white_center_size10)
                    sheet.merge_range(18,4,19,7, "※右表にチェック", format_white_center_size10)
                    sheet.merge_range(20,4,21,7, "キシミ音", format_white_center_size10)
                    sheet.merge_range(22,4,23,7, "※脚部の強度確認を必ず実施して下さい", format_white_center_size10)
                    sheet.merge_range(24,4,25,7, "ガタツキ・脚裏の汚れを確認", format_white_center_size10)
                    sheet.merge_range(26,4,27,7, "貼り忘れ注意", format_white_center_size10)
                    sheet.merge_range(28,4,29,7, "", format_white_center_size10)

                    #table 5
                    sheet.merge_range(31,0,31,3, "■梱包時　作業確認表", format_head_title)
                    sheet.merge_range(32,0,33,0, "確認", format_gray_center_size9)
                    sheet.merge_range(32,1,33,3, "作業項目", format_gray_center_size9)
                    sheet.merge_range(32,4,33,7, "注意点", format_gray_center_size9)
                    ...
                    sheet.merge_range(34,1,36,3, "同梱物", format_white_left_size10)
                    sheet.merge_range(37,1,39,3, "梱包", format_white_left_size10)
                    sheet.merge_range(40,1,42,3, "", format_white_left_size10)
                    sheet.merge_range(34,4,36,7, "同梱物の確認", format_white_center_size10)
                    sheet.merge_range(37,4,39,7, "梱包仕様・製品梱包間違い", format_white_center_size10)
                    sheet.merge_range(40,4,42,7, "", format_white_center_size10)

                    #table 6
                    sheet.merge_range(1,10,2,12, "■不良箇所確認表", format_head_title)
                    sheet.merge_range(3,10,4,12, "", format_gray_center_size9)
                    sheet.merge_range(3,13,4,15, "張り後", format_gray_center_size9)
                    sheet.merge_range(3,16,4,18, "最終検品", format_gray_center_size9)
                    sheet.merge_range(5,10,7,12, "検品者", format_white_center_size10)
                    sheet.merge_range(8,10,9,12, "検品日", format_white_center_size10)
                    ...
                    #table 7
                    sheet.merge_range(11,10,12,12, "不良項目", format_gray_center_size9)
                    sheet.merge_range(11,14,12,15, "不良箇所詳細", format_gray_center_size9)
                    sheet.merge_range(11,13,12,13, "確認", format_gray_center_size9)
                    sheet.merge_range(11,16,12,16, "確認", format_gray_center_size9)
                    sheet.merge_range(11,17,12,18, "不良箇所詳細", format_gray_center_size9)

                    sheet.merge_range(13,10,27,10, "木"+ "\n" + "部", format_wrap_white_center_size9)
                    sheet.merge_range(28,10,36,10, "張"+ "\n" + "り"+ "\n" + "後", format_wrap_white_center_size9)

                    sheet.merge_range(13,11,15,12, "ワレ", format_white_center_size10)
                    sheet.merge_range(16,11,18,12, "キズ・へこみ", format_white_center_size10)
                    sheet.merge_range(19,11,21,12, "木目・節・白太", format_white_center_size10)
                    sheet.merge_range(22,11,24,12, "接合部スキマ・グラツキ", format_white_center_size10)
                    sheet.merge_range(25,11,27,12, "塗装不良・ムラ", format_white_center_size10)
                    sheet.merge_range(28,11,30,12, "張り仕上がり", format_white_center_size10)
                    sheet.merge_range(31,11,33,12, "張地不良（ベルト・ファスナー", format_white_center_size10)
                    sheet.merge_range(34,11,36,12, "汚れ・銀ペン・接着剤", format_white_center_size10)
                    sheet.merge_range(37,10,39,12, "その他不良", format_white_center_size9)
                    ...
                    #table 8
                    sheet.merge_range(42,14,44,15, "出荷日", format_gray_center_size14)
