...
class productSpec(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        format_title = workbook.add_format({'align': 'center','valign': 'vcenter','bg_color':'#ccffff'})
        format_left = workbook.add_format({'align': 'left','text_wrap':True,'bold':True})
        format_table = workbook.add_format({ 'align': 'center','valign': 'vcenter','bg_color': '#d6dce4','border':1})
        format_cell_white = workbook.add_format({'align': 'center','valign': 'vcenter','border':1,'bg_color': '#F2F2F2'})
        format_cell_white_right = workbook.add_format({'align': 'right','valign': 'vcenter','border':1,'bg_color': '#F2F2F2'})
        format_cell_yellow = workbook.add_format({'align': 'center','valign': 'vcenter','border':1,'bg_color': '#FFFFCC'})
        format_cell_yellow_right = workbook.add_format({'align': 'right','valign': 'vcenter','border':1,'bg_color': '#FFFFCC'})
        format_cell_green = workbook.add_format({'align': 'center','valign': 'vcenter','border':1,'bg_color': '#CCFFCC'})
        format_cell_green_right = workbook.add_format({'align': 'right','valign': 'vcenter','border':1,'bg_color': '#CCFFCC'})
        format_cell_blue = workbook.add_format({'align': 'center','valign': 'vcenter','border':1,'bg_color': '#ccffff'})
        format_cell_blue_right = workbook.add_format({'align': 'right','valign': 'vcenter','border':1,'bg_color': '#ccffff'})
        format_cell_purple = workbook.add_format({'align': 'center','valign': 'vcenter','border':1,'bg_color': '#FFCCFF'})
        format_cell_purple_right = workbook.add_format({'align': 'right','valign': 'vcenter','border':1,'bg_color': '#FFCCFF'})
        format_cell_gray= workbook.add_format({'align': 'center','valign': 'vcenter','text_wrap':True, 'border': 1,'bg_color': '#7f7f7f'})
        format_cell_gray_right= workbook.add_format({'align': 'right','valign': 'vcenter','text_wrap':True, 'border': 1,'bg_color': '#7f7f7f'})
        format_cell_gray_left= workbook.add_format({'align': 'left','valign': 'vcenter','text_wrap':True, 'border': 1,'bg_color': '#7f7f7f'})
        ...
        for p_template in lines :
            ...
            sheet.set_column("J:J", width=0)
            sheet.set_column("K:K", width=27)
            sheet.set_column("N:N", width=12)
            sheet.set_column("O:O", width=12)
            sheet.set_column("P:P", width=12)
