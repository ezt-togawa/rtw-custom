                ...
                if mrp.picking_type_id.warehouse_id.partner_id:
                    if mrp.lang_code == "ja_JP":
                        if mrp.mrp_workorder_state == 'wk_001':
                            sheet.write(3, 0, _('糸島工場 御中'), format_text_14)
                        elif mrp.mrp_workorder_state == 'wk_002':
                            sheet.write(3, 0, _('品質管理部 御中'), format_text_14)
                        else:
                            sheet.write(3, 0, mrp.picking_type_id.warehouse_id.partner_id.name + ' 御中', format_text_14)
                    else:
                        if mrp.mrp_workorder_state == 'wk_001':
                            sheet.write(3, 0, 'Dear Itoshima Factory', format_text_14)
                        elif mrp.mrp_workorder_state == 'wk_002':
                            sheet.write(3, 0, 'Dear Quality Control', format_text_14)
                        else:
