...
class SaleOrderExcelReport(models.Model):
    ...
    def _compute_sale_partner_info(self):
        for record in self:
            ...
            record.sale_order_partner_info = partner_info.rsplit("-")
    ...
    def _compute_sale_order_format_date(self):
        for record in self:
            ...
            if record.preferred_delivery_date:
                record.sale_order_preferred_delivery_date = record._format_date(record.preferred_delivery_date, record.lang_code)
            else:
