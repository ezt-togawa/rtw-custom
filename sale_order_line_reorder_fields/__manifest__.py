# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'sale_management', 'sale_sourced_by_line', 'stock' , 'sale' , 'sale_order_rtw' , 'product_spec_rtw', 'sale_order_line_planned_date' , 'sale_order_line_product_pack' ,
                'sale_order_line_outlook_stock','sale_order_line_delivery_confirmation','sale_order_line_warehouse','sale_line_bom_stock','sale_stock','product_configurator_sale','rtw_stock_move_line'],
